...
.userID("YOUR_USER_ID") // 分配给调用方的userID
.appkey("YOUR_APPKEY") // 分配给调用方的appkey
...
```
Trio.with()  
. requestDivided (queryStr, new RequestCallback<DivideResult> () { 
void onSuccess(DivideResult result) { 
// Deal with success result 
} 
...
![](/doc/assets/sdk/1534910287472.jpg)

SentenceDivideResult各字段含义：
![](/doc/assets/sdk/1534910362200.jpg)
...
接口定义：
```
void requestNERInfo (String query, RequestCallback<NerResult> callback)
```
或
```
void requestNERInfo (String query, GPS_TYPE gpsType, double longitude, double latitude, RequestCallback<NerResult> callback)
```
其中：
```
...
```
Trio.with()  
. requestNERInfo (queryStr, new RequestCallback<NerResult>() { 
void onSuccess(NerResult nerResult) { 
// Deal with success result 
} 
void onError(String error) { 
// Deal with error result 
...
```
Trio.with()  
. requestNERInfo (queryStr,
Trio.GPS_TYPE.GCJ02,
“116.41127139”,
“39.99479325”,
new RequestCallback<NerResult>() { 
void onSuccess(NerResult nerResult) { 
// Deal with success result 
} 
void onError(String error) { 
...
"log_id": "6a72d553-ef88-498c-beed-badf2adaa21b",
"result_list": [
{
"divided_list": [
"我",
...
"calendar_list": [
{
"startTimeStamp": 1534986000000,
"startOffset": 1,
"endTimeStamp": -1,
"endOffset": 0,
"startTimeStr": "2018-08-23 09",
"theme": "观影提醒：芳华",
"themeOffset": 0
}
]
...
"relScore": 1,
"url": "http://phoneapi.sanjiaoshou.net/nlp/q?key:Vsf-m4SSu9vlrhb5pqhpzybiBHM0vSe6OHdfAE9T0ShClttvRnwkcP2LVo-GyeRgz_lHIPuGCLG8obEcxHwNf5h4k1MFoZXhkh714gCqrYdsADTuA6vT1f9c3tCoCgx-S_YqiC4bg0c1p952r7-51VbjWRR2c0oMmAo7aYarjFNFp0SvJ6XKpoghiZXyIyOb20E4Ci3ONMCQy1NjoKloSzWajrjdI7-W2Np5y38rgxhZbnZZyIeQZKbmXWSdbv9_zpQdQy0MFAE=",
...
"relScore": 1,
"url": "http://phoneapi.sanjiaoshou.net/nlp/q?key:Vsf-m4SSu9vlrhb5pqhpzybiBHM0vSe6OHdfAE9T0ShClttvRnwkcP2LVo-GyeRgz_lHIPuGCLG8obEcxHwNf5h4k1MFoZXhkh714gCqrYdsADTuA6vT1f9c3tCoCgx-S_YqiC4bg0c1p952r7-51VbjWRR2c0oMmAo7aYarjFNFp0SvJ6XKpoghiZXyIyOb20E4Ci3ONMCQy1NjoKloS5YoTy_JDGMc",
...
"relScore": 1,
"url": "http://phoneapi.sanjiaoshou.net/nlp/q?key:Vsf-m4SSu9vlrhb5pqhpzybiBHM0vSe6OHdfAE9T0ShClttvRnwkcMfsVeooKi58xZtKt0As9g--qD7y1kKfkALhgwJQXxzhZoAc1Hrz4g-lf9I6k9o8ydz-j2qj7YsOprJsr6LWIM_tzedgW9fAd8vUGTJiLTLFp81w-c_9yZ6rjov037prj0qusyqxTKuL",
"intent": "androidamap://poi?sourceApplication=trio&dev=0&keywords=%E4%BA%94%E9%81%93%E5%8F%A3",
"source": "Gaode"
}
]
...
"url": "http://phoneapi.sanjiaoshou.net/nlp/q?key:Vsf-m4SSu9vlrhb5pqhpzybiBHM0vSe6OHdfAE9T0ShClttvRnwkcP2LVo-GyeRgFX0z10fGtRl4iC2egleGfrjFPBuOzMckWPggD3q5RXvphwxcixWrZrGFoJrsgr2sGj6h6YuRVyKKzmfkBZQBeQ==",
...
![](/doc/assets/sdk/custom_info_list.png)
...
界面元素分布如下：
![](/doc/assets/sdk/ui_tpl_13.png)
视觉效果可以参考下面两种：
![](/doc/assets/sdk/ui_tpl_13_demo.png)

####附录
#####附录1：支持类型表（动态扩展中）
![](/doc/assets/sdk/support_type_1)
![](/doc/assets/sdk/support_type_2.jpg)
![](/doc/assets/sdk/support_type_3.jpg)
![](/doc/assets/sdk/support_type_4.jpg)
...
intent.setData(Uri.parse(uriString)); startActivity(intent);
```